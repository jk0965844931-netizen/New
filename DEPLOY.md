...
สำหรับ MangaDex ให้ใช้ URL แบบ `https://mangadex.org/chapter/<uuid>` แอปจะไม่เปิด iframe แต่จะเรียก MangaDex API endpoint `https://api.mangadex.org/at-home/server/<uuid>` เพื่อสร้างรายการรูปภาพแล้วสลับกลับไป reader อัตโนมัติ
